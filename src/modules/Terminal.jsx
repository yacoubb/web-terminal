...
import { hyperColors } from '../components/HyperTheme'
import { defaultName, linePrompt } from '../components/TerminalConfig'
...
const Terminal = ({
                ...
                <>
                    {line.split('\n').map((subLine, i) => (
                        <div key={i} id={subLine}>
                            <div
                                dangerouslySetInnerHTML={{ __html: ansiHTML(subLine) }}
    ...
    const spawn = (command, args) => {
        ...
        const currentContext = {
            name,
            history: [...history, commandToLine(command)],
